...
CREATE TABLE `cart` (
  ...
  KEY `cart_customer_id_fk` (`customerId`),
  CONSTRAINT `cart_customer_id_fk` FOREIGN KEY (`customerId`) REFERENCES `customer` (`id`),
...
INSERT INTO `orderdetail` VALUES ('p11','#99F4','H22244',2,0),('p22','#99F5','H2G5',3,0);
...
-- Dump completed on 2023-11-03  9:40:46
