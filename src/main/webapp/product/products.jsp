...
<jsp:useBean id="listProduct" scope="request" type="java.util.List"/>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                ...
                <li  class="active"><a href="product?action=products">Products</a></li>
            </ul>
            <!-- /NAV -->
        </div>
        <!-- /responsive-nav -->
